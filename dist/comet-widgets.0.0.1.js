var CometWidgets = (function (exports,$) {
'use strict';
...
var CarouselTemplate = /** @class */ (function () {
    ...
    CarouselTemplate.renderWait = function (options) {
        var carousel = { id: options.id, slides: [], tpls: { indicators: '', items: '' } };
    ...
    CarouselTemplate.render = function (slides, options) {
        ...
        for (var i in carousel.slides) {
            tpls.indicators = tpls.indicators + CarouselTemplate.getTemplate('indicator', { carousel: carousel, i: i });
        }
        for (var i in carousel.slides) {
            tpls.items = tpls.items + CarouselTemplate.getTemplate('item', { carousel: carousel, i: i });
        }
...
var Carousel = /** @class */ (function () {
    function Carousel(id, userOptions) {
        ...
        this.load = new Promise(function (resolve, reject) {
            ...
            _this.options = $.extend({}, defaultOptions, userOptions);
            if (_this.options.selector && _this.options.selector.match(/^\#[a-zA-Z0-9\_\-]+$/g)) {
            ...
            promise.then(function (album) {
                ...
                ApiService.getAlbumMedias(album.uuid, { format: _this.choosenFormat }).then(function (medias) {
                    // Set data
                    if (!medias.length) {
                        reject(false);
                        return;
...
//# sourceMappingURL=comet-widgets.0.0.1.js.map
